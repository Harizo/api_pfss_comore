...
class Visite_domicile_raison_model extends CI_Model {
    protected $table = 'visite_domicile_raison';
    ...
    public function _set($visite_domicile) {
        return array(
            ...
            'id_raison_visite_domicile'  => $visite_domicile['id_raison_visite_domicile'],
        );
    }
    ...
    public function findAllByIdvisite($id_visite) {
		$requete="select v.id,v.id_visite,v.id_raison_visite_domicile,"
				."rv.description"
				." from ".$this->table." as v "
				." left join raison_visite_domicile as rv on rv.id=v.id_raison_visite_domicile"
				." where v.id_visite=".$id_visite
				." order by v.id_visite";
