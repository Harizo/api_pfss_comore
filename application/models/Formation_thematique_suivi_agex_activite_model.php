...
class Formation_thematique_suivi_agex_activite_model extends CI_Model {
    protected $table = 'formation_thematique_suivi_agex_activite';
    ...
    public function getformation_thematique_suivi_agex_activite()  {
        $result =  $this->db->select('*')
                        ->from($this->table)
    ...
    public function findAlltheme_formation() {
        $result =  $this->db->select('*')
