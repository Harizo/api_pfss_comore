...
class Fiche_plan_relevement_objdesc_quatre extends REST_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('fiche_plan_relevement_objdesc_quatre_model', 'fproaMng');
    }
    ...
    public function index_post() 
    {
		...
		$data = array(
            ...
            'risque_eventuelle'             => $this->post('risque_eventuelle'),
            'solution_prevu'                => $this->post('solution_prevu')
		);       
