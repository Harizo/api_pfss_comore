...
class Fiche_plan_relevement_objdesc_un_deux extends REST_Controller {
    ...
    public function index_post() 
    {
		...
		$data = array(
            ...
            'disponibilite_intrant'         => $this->post('disponibilite_intrant'),
            'disponibilite_terrain'         => $this->post('disponibilite_terrain'),
            'capacite_technique'            => $this->post('capacite_technique')
		);       
