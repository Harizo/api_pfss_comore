...
class Infrastructure extends REST_Controller {
    ...
    public function index_get() {
        ...
        if ($menu=="getinfrastructurebyvillage") {
               
            $infrastructure = $this->InfrastructureManager->getinfrastructurebyvillage($id_village);
                if ($infrastructure) {
                    //$data = $infrastructure;
        ...
        } elseif ($menu=="getinfrastructurebyvillageandchoisitype") {
