...
class Fiche_suivi_plan_relevement_presentation extends REST_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('fiche_suivi_plan_relevement_presentation_model', 'fproaMng');
    }
    ...
    public function index_post() 
    {
		...
		$data = array(
            ...
            'date_demarage_activite'        => $this->post('date_demarage_activite'),
            'objectif'                      => $this->post('objectif'),
            'stade_realisation_activite'    => $this->post('stade_realisation_activite')
		);       
