		...
		if ($id) {
			...
			if ($menu) {
                foreach ($menu as $key => $value) {
					...
					// Recuperation après clique sur onglet correspondant => 1
                    $data[$key]['detail_zone_intervention_programme_charge'] = 0;
                    $data[$key]['detail_financement_programme_charge'] = 0;
                    $data[$key]['detail_intervention_charge'] = 0;
				}
			}
		}
        if (count($data)>0) {
