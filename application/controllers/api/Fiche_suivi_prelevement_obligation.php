...
class Fiche_suivi_prelevement_obligation extends REST_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('fiche_suivi_prelevement_obligation_model', 'fproaMng');
    }
    ...
    public function index_post() 
    {
		...
		$data = array(
            ...
            'respect_obligation'    => $this->post('respect_obligation'),
