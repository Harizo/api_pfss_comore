...
class Fiche_plan_relevement_plan_production_deux extends REST_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('fiche_plan_relevement_plan_production_deux_model', 'fproaMng');
    }
    ...
    public function index_get() 
    {
		...
		if ($id_identification&&$type) 
        {
			$tmp = $this->fproaMng->findBy_id_identification($id_identification, $type);
			if($tmp) 
            {
				$data=$tmp;
			}
    ...
    public function index_post() 
    {
		...
		$data = array(
            ...
            'numero_materiel'                    => $this->post('numero_materiel')
		);       
