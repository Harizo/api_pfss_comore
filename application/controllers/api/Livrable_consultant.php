...
class Livrable_consultant extends REST_Controller {
		...
		$data = array(
         ...
         if ($supprimer == 0)  {
            if ($id == 0) {
                ...
                $dataId = $this->LivrableconsultantManager->add($data);
                if (!is_null($dataId)) {
                    $this->response([
                        'status' => TRUE,
                        'response' => $dataId,
                ...
                $update = $this->LivrableconsultantManager->update($id, $data);              
                if(!is_null($update)){
                    $this->response([
                        'status' => TRUE, 
                        'response' => $id,
            ...
            $delete = $this->LivrableconsultantManager->delete($id);          
            if (!is_null($delete)) {
                $this->response([
                    'status' => TRUE,
                    'response' => 1,
