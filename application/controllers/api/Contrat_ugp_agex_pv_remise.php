...
class Contrat_ugp_agex_pv_remise extends REST_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('contrat_ugp_agex_pv_remise_model', 'pvrmsMng');
    }
    ...
    public function index_get() {
        ...
        {
			$tmp = $this->pvrmsMng->findByContrat_ugp_agex($id_contrat_ugp_agex);
			if($tmp) 
            {
				$data=$tmp;
    ...
    public function index_post() 
    {
		...
		$data = array(
            ...
            'nom_representant_cps'       => $this->post('nom_representant_cps'),
