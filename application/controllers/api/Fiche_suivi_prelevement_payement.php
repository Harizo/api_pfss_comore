...
class Fiche_suivi_prelevement_payement extends REST_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('fiche_suivi_prelevement_payement_model', 'fproaMng');
    }
    ...
    public function index_post() 
    {
		...
		$data = array(
            ...
            'etat_paiement'       => $this->post('etat_paiement'),
