...
class Contrat_ugp_agex_signataires extends REST_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('contrat_ugp_agex_signataires_model', 'cuasngMng');
    }
    ...
    public function index_post() 
    {
		...
		$data = array(
            ...
            'titre_signatire'     => $this->post('titre_signatire')
		);       
