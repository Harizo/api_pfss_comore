...
class Fiche_supervision_direction_regional extends REST_Controller {
    public function __construct() {
        parent::__construct();
        $this->load->model('fiche_supervision_direction_regional_model', 'fpriManager');
    ...
    public function index_post() {
		...
		$data = array(
            ...
            'nom_direction_regional'          => $this->post('nom_direction_regional')
		);               
        if ($supprimer == 0) {
            if ($id == 0) {
                if (!$data) {
