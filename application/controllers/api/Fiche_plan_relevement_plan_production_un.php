...
class Fiche_plan_relevement_plan_production_un extends REST_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('fiche_plan_relevement_plan_production_un_model', 'fproaMng');
    }
    ...
    public function index_post() 
    {
		...
		$data = array(
            ...
            'materiel_entrant'              => $this->post('materiel_entrant'),
            'unite'                         => $this->post('unite'),
            'disponible'                    => $this->post('disponible'),
            'achercher'                     => $this->post('achercher'),
            'acheter_ou'                    => $this->post('acheter_ou')
		);       
