		...
		if ($id) {
			...
			if ($menu) {
                ...
                foreach ($menu as $key => $value) {
                    ...
                    $data[$key]['variable_choix_unique'] = array(); // Choix unique
                    $data[$key]['variable_choix_multiple'] = array(); // Choix unique
                    $data[$key]['detail_type_transfert'] = array();
                    $data[$key]['detail_charge'] = 0;
                    $data[$key]['detail_type_transfert_charge'] = 0;
                    $data[$key]['detail_financement_intervention_charge'] = 0;
                    $data[$key]['detail_variable_charge'] = 0;
                    $data[$key]['detail_zone_intervention_charge'] = 0;
				}
			}			
        if (count($data)>0) {
            $this->response([
